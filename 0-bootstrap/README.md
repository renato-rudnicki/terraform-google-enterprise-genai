...
1. Create a folder called `gcp-bootstrap` at the same level of the `terraform-google-enterprise-genai`. Copy the `0-bootstrap` content and `.gitignore` to `gcp-bootstrap`.
   ...
   cp -R terraform-google-enterprise-genai/0-bootstrap/* gcp-bootstrap/

   cp terraform-google-enterprise-genai/.gitignore gcp-bootstrap
   ```
